				...
				<form action="cadastrar.php" name="form1" method="POST" enctype="multipart/form-data">
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							...
							<input type="tel" data-mask="(00) 0000-0000" placeholder="(00) 0000-0000" data-mask-selectonfocus="true" class="form-control" id="apoio_telefone" name="apoio_telefone" required>
						</div>
					</div>
